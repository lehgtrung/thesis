...
\begin{equation}
\hat{y} = \operatorname*{argmax}_{y_t \in V} (p(y_t | y < t, x))
\end{equation}
...
\begin{equation*}
\hat{y_t} = \operatorname*{argmax}_{y_t \in V} p(y_t | I, am)
\end{equation*}
