...
Kiến trúc Bộ mã hóa-Bộ giải mã như tên gọi, nó có sử dụng 2 mô hình LSTM. Trong đó, mỗi mô hình LSTM được đảm nhiệm một vị trí Bộ mã hóa hoặc Bộ giải mã. Cụ thể:
\begin{itemize}
	\item 
\end{itemize}
