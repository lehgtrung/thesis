...
\begin{itemize}
	...
	\begin{itemize}
		\item Toàn cục: phiên bản này xem xét tất cả trạng thái ẩn trong bộ mã hóa trong mỗi bước giải mã.
		\item Cục bộ: phiên bản này chỉ xem xét một số trạng thái ẩn trong bộ mã hóa trong mỗi bước giải mã.
	\end{itemize}
\end{itemize}}
\end{quote}
