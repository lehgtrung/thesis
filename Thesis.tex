...
\includepdf[pages=1-3]{docs/NhanXet}
...
%\makeglossaries
%\nomenclature{$LSTM:$}{Long short-term memory - Bộ nhớ ngắn hạn dài}
%\nomenclature{$SGD:$}{Stochastic Gradient Descent - Thuật toán hạ dốc gradient}
...
\newcommand\sigmoid[0]{\mathrm{sigmoid}}
