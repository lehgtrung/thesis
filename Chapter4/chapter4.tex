...
\begin{table}
	...
	\begin{tabular}{|l|l|c|} 
		...
		Cơ bản                                           & 8.03                 & 15.04           \\ 
		\hline
		Cơ bản + global (general) + input feed + unk rpl & \textbf{5.22 (-2.81)}         & \textbf{22.87 (+7.79)}   \\
		\hline
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{|l|c|c|c|} 
		...
		Cơ bản                                                   & 8.03                                   & 15.08          &                      \\ 
		\hline
		Cơ bản + global (dot)                                    & 6.1                                    & 18.62          & 18.81                \\ 
		\hline
		Cơ bản + global (general)                                & 4.98                                   & 19.99          & 22.33                \\ 
		\hline
		Cơ bản + global (dot) + input feed                       & 5.43                                   & 19.78          & 22.24                \\ 
		\hline
		Cơ bản + global (general) + input feed                   & 5.22                                   & \textbf{20.41} & \textbf{22.87}       \\ 
		\hline
		Cơ bản + local-p (general) + input feed                  & 5.43                                   & 20.37          & 22.75                \\
		\hline
	\end{tabular}
	\caption{So sánh kết quả giữa các mô hình Attention với nhau.}
	\label{tab_attn-vs-attn}
\end{table}
Kết quả của các mô hình Attention được thể hiện trong bảng \ref{tab_attn-vs-attn}. 
