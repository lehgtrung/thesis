...
Từ word embedding được tạo ra bởi GS Bengio và cộng sự vào năm 2003 \cite{wordembeddingBengio2003} khi họ đã huấn luyện một mô hình ngôn ngữ nơ-ron đồng thời học biểu diễn từ thông qua các tham số của mô hình. Tuy nhiên công trình này vẫn chưa thực sự thành công, cho tới năm 2008, Collobert và Weston \cite{wordembeddingCollobert2008} đã đề xuất một kiến trúc mạng nơ-ron sâu tổng quát. 
Hiện nay, có hai cách chính để học word embedding.
\begin{itemize}
	\item Học theo chiến lược học không giám sát: sử dụng các thuật toán học trên tập dữ liệu không có nhãn nhằm tìm ra biểu diễn từ tốt nhất dựa trên tập dữ liệu. Thường là những tập dữ liệu thu thập được từ các nguồn khác nhau về mà chưa có được xử lí, đánh nhãn để giải quyết cho một bài toán cụ thể nào. Các tập dữ liệu này thường là dùng để huấn luyện cho mô hình ngôn ngữ.
	\item Học theo chiến lược có giám sát: mô hình học trên dữ liệu huấn luyện có nhãn để giải quyết một bài toán nhất định (Phân tích ý kiến người dùng, Dịch máy, v.v...). Các véc-tơ biểu diễn từ là các véc-tơ tham số trong mô hình. Mô hình sẽ học đồng thời giải quyết bài toán và các véc-tơ biểu diễn từ.
\end{itemize}

Hiện nay học theo chiến lược học không giám sát đang có được những kết quả ấn tượng.
