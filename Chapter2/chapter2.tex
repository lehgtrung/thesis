...
Khác với các lĩnh vực khác như Thị giác máy tính, Xử lý âm thanh, Phân tích dữ liệu, v.v... có thể biểu diễn các thông tin, dữ liệu thu thập được trên máy tính một cách dễ dàng qua các con số (như trong Thị giác máy tính thì biểu diễn bằng các điểm ảnh), lĩnh vực Xử lí ngôn ngữ tự nhiên gặp khó khăn trong việc biểu diễn các từ ngữ trên máy tính dưới dạng các con số. Bởi vì để máy tính có thể hiểu được và xử lí được những thông tin đến từ thế giới thực, những thông tin đó phải được biểu diễn dưới dạng các con số do máy tính chỉ hiểu được duy nhất một thứ đó là các con số. Ví dụ: những từ ngữ như "tôi", "bạn", "học", v.v... được viết dưới dạng ngôn ngữ tự nhiên và làm sao để chúng ta biểu diễn nó cho máy tính hiểu. Đó chính là một trong những bài toán rất khó trong lĩnh vực Xử lí ngôn ngữ tự nhiên mà cần phải được giải quyết. Những phương pháp mà dùng để biểu diễn ngôn ngữ tự nhiên thành dạng số (mã hóa) được gọi là \textit{word embedding} (tạm dịch là \textit{phép nhúng từ}).
